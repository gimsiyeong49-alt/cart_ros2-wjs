...
class Metaclass_Command(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'roboteq_interfaces.srv.Command')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from roboteq_interfaces.srv import _command
...
class Command(metaclass=Metaclass_Command):
    from roboteq_interfaces.srv._command import Command_Request as Request
    from roboteq_interfaces.srv._command import Command_Response as Response
