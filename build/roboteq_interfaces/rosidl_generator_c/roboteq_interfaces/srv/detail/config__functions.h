...
#ifndef ROBOTEQ_INTERFACES__SRV__DETAIL__CONFIG__FUNCTIONS_H_
#define ROBOTEQ_INTERFACES__SRV__DETAIL__CONFIG__FUNCTIONS_H_
 ...
 * calls
 * roboteq_interfaces__srv__Config_Request__init().
...
/**
 * It calls
 * roboteq_interfaces__srv__Config_Request__fini()
 ...
 * roboteq_interfaces__srv__Config_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * roboteq_interfaces__srv__Config_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * roboteq_interfaces__srv__Config_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_roboteq_interfaces
...
/**
 * It calls
 * roboteq_interfaces__srv__Config_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_roboteq_interfaces
...
/**
 * It allocates the memory for the array and calls
 * roboteq_interfaces__srv__Config_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_roboteq_interfaces
...
/**
 * It calls
 * roboteq_interfaces__srv__Config_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOTEQ_INTERFACES__SRV__DETAIL__CONFIG__FUNCTIONS_H_
