...
#include "roboteq_interfaces/srv/detail/config__rosidl_typesupport_fastrtps_c.h"
...
using _Config_Request__ros_msg_type = roboteq_interfaces__srv__Config_Request;
...
size_t get_serialized_size_roboteq_interfaces__srv__Config_Request(
  const void * untyped_ros_message,
...
static uint32_t _Config_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_roboteq_interfaces__srv__Config_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_roboteq_interfaces
size_t max_serialized_size_roboteq_interfaces__srv__Config_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_roboteq_interfaces__srv__Config_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roboteq_interfaces, srv, Config_Request)() {
...
using _Config_Response__ros_msg_type = roboteq_interfaces__srv__Config_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_roboteq_interfaces
size_t get_serialized_size_roboteq_interfaces__srv__Config_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Config_Response__ros_msg_type * ros_message = static_cast<const _Config_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_roboteq_interfaces__srv__Config_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_roboteq_interfaces
size_t max_serialized_size_roboteq_interfaces__srv__Config_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_roboteq_interfaces__srv__Config_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roboteq_interfaces, srv, Config_Response)() {
...
// already included above
// #include "roboteq_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "roboteq_interfaces/srv/config.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roboteq_interfaces, srv, Config)() {
